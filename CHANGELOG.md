...
* Ability to disable ParentProcessWatcher through vm-args flag `-DwatchParentProcess=\"false\"`. On Windows it is disabled by default. See [#116](https://github.com/redhat-developer/vscode-xml/pull/116).
...
* Cleaned up skipped unit tests. See [lsp4xml#319](https://github.com/angelozerr/lsp4xml/issues/319).
* Verified that logger settings were actually set on startup before updating settings. See [lsp4xml#81](https://github.com/angelozerr/lsp4xml/issues/81).
...
* Closing CDATA tag throws exception. See [lsp4xml#341](https://github.com/angelozerr/lsp4xml/issues/341).
