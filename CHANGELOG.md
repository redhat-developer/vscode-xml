...
* Ability to edit start/end tag simultaneously under `xml.matchingTagEditing` preference. Can be toggled on/off on Windows/Linux through `ctrl+shift+f2` and on Mac `cmd+shift+f2`. See [#130](https://github.com/redhat-developer/vscode-xml/issues/130).
