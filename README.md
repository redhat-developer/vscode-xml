...
Since 0.10.0:
* `xml.matchingTagEditing`: Enable/disable ability to simultaneously edit the start and end tag of an element. Default is `true`. Can be toggled on/off on Windows/Linux through `ctrl+shift+f2` and on Mac `cmd+shift+f2`.
